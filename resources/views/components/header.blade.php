<nav class="bg-black border-bottom">
    <div class="container d-flex flex-wrap">
        <ul class="nav me-auto">
            <li class="nav-item"><a href="#" class="nav-link"><i class="fab fa-instagram fa-lg text-white"></i></a>
            </li>
            <li class="nav-item"><a href="#" class="nav-link"><i class="fab fa-whatsapp fa-lg text-white"></i></a>
            </li>
        </ul>
        <ul class="nav">
            <li class="nav-item"><a href="#"
                    class="nav-link text-white text-uppercase">{{ __('labels.contact') }}</a></li>
        </ul>
    </div>
</nav>
        ...
        <div class="row w-100 d-flex justify-content-between align-items-center">
            <div class="col-12 col-lg-4 d-flex justify-content-lg-start justify-content-center mb-3 mb-lg-0">
                <ul class="nav d-none d-lg-flex">
                    <li class="nav-item"><a href="#"
                            class="nav-link link-body-emphasis px-2 text-uppercase">{{ __('labels.events') }}</a></li>
                    <li class="nav-item"><a href="#"
                            class="nav-link link-body-emphasis px-2 text-uppercase">{{ __('labels.spaces') }}</a></li>
                    <li class="nav-item"><a href="#"
                            class="nav-link link-body-emphasis px-2 text-uppercase">{{ __('labels.calendar') }}</a></li>
                </ul>
            </div>
            ...
            <div class="col-12 col-lg-4 d-flex justify-content-lg-end justify-content-center mt-3 mt-lg-0">
                <ul class="nav d-none d-lg-flex">
                    <li class="nav-item"><a href="{{ route('login') }}"
                            class="nav-link link-body-emphasis px-2 me-2 text-uppercase">{{ __('labels.login') }}</a>
                    </li>
            ...
            <div class="col-12 d-flex justify-content-center">
                <ul class="nav d-lg-none">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-lime-yellow text-uppercase" href="#" id="navbarDropdown"
